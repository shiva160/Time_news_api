#!/usr/bin/env python3
"""
Test script for the Time Stories API
Tests the scraping functionality directly without running the server
"""
...
# Fetch HTML
print("\n1️⃣ Fetching HTML from Time.com...")
...
if html:
    ...
    # Extract stories
    print("\n2️⃣ Extracting latest 6 stories...")
    ...
    if len(stories) > 0:
        ...
        if len(stories) == 6:
            ...
            print(f"⚠️  {len(stories)} stories returned (expected 6)")
    else:
